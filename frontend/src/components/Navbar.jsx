    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group cursor-pointer">
          <div className="relative bg-gradient-to-br from-indigo-600 to-violet-700 p-2 rounded-2xl shadow-[0_10px_30px_rgba(79,70,229,0.45)] dark:shadow-[0_10px_30px_rgba(15,23,42,0.8)] group-hover:scale-110 group-hover:-translate-y-0.5 transition-transform duration-300">
        ...
        <div className="hidden lg:flex items-center gap-8">
          <Link
            to="/"
            className="relative text-[14px] font-semibold text-slate-600 dark:text-slate-300 hover:text-indigo-500 dark:hover:text-indigo-300 transition-colors group"
          >
            <span>Home</span>
            <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-gradient-to-r from-indigo-500 to-violet-500 rounded-full transition-all duration-300 group-hover:w-8" />
          </Link>
          <Link
            to="/about"
            className="relative text-[14px] font-semibold text-slate-600 dark:text-slate-300 hover:text-indigo-500 dark:hover:text-indigo-300 transition-colors group"
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-violet-600 to-indigo-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full bg-white/90 dark:bg-slate-950/90 backdrop-blur-2xl border-b border-white/50 dark:border-slate-800 px-6 py-6 flex flex-col gap-4 shadow-[0_18px_40px_rgba(15,23,42,0.35)]">
          ...
          <button
            ...
            className="mt-2 w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white py-3.5 rounded-xl font-semibold text-sm shadow-[0_10px_30px_rgba(79,70,229,0.6)] transition-all"
          >
