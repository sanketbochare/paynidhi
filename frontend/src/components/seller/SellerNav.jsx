    ...
    <>
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-64 bg-white border-r border-slate-200/80 fixed inset-y-0 left-0 z-30 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        ...
        <div className="px-4 py-4 border-b border-slate-100">
          <div className="relative flex items-center gap-3 rounded-2xl bg-white border border-slate-200/60 p-2.5 shadow-[0_2px_12px_-4px_rgba(15,143,121,0.15)] hover:border-[#7FE0CC]/60 transition-all duration-300">
        ...
        {!isKycComplete ? (
          ...
          <div className="px-3 pb-3 pt-2 border-t border-slate-100 bg-white">
            <button
              ...
              className="w-full flex items-center gap-3 rounded-xl px-3 py-2.5 text-[11px] font-semibold transition-all duration-200 border shadow-sm bg-slate-50 text-slate-800 hover:bg-slate-100 hover:shadow-md hover:-translate-y-0.5 border-slate-200"
            >
